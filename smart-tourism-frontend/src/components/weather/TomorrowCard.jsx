...
export default function TomorrowCard({ cityName, tomorrow, currentTemp }) {
    return (
        <div className="relative min-h-[260px] overflow-hidden rounded-3xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            {/* Background image */}
            <img
                src="/umbrella.jpg"
            ...
            <div className="relative z-10 flex h-full min-h-[260px] flex-col justify-between p-5">
                <div>
                    <p className="text-sm font-medium text-white/90">Tomorrow</p>
...
//                         className="h-[190px] w-auto object-contain drop-shadow-lg"
//                         loading="lazy"
//                     />
//                 </div>
//             </div>
