...
public class HotelMapper {
    ...
    public static RoomResponseDto toRoomResponseDto(Room room, Integer availableRooms) {
        int safeAvailable = availableRooms != null ? availableRooms : 0;
        ...
        return RoomResponseDto.builder()
                ...
                .imageUrls(room.getImageUrls() != null ? room.getImageUrls() : Collections.emptyList())
                .amenities(parseAmenities(room.getAmenities()))
                .available(safeAvailable > 0)
                .build();
    }
    ...
    public static HotelResponseDto toHotelResponseDtoFromNativeQuery(Object[] result) {
        ...
        BigDecimal latitude = (BigDecimal) result[3];
        BigDecimal longitude = (BigDecimal) result[4];
        BigDecimal pricePerNight = result[5] != null ? new BigDecimal(result[5].toString()) : null;
        BigDecimal rating = result[6] != null ? new BigDecimal(result[6].toString()) : null;
        String amenitiesJson = (String) result[7];
        Boolean availabilityStatus = result[8] != null ? (Boolean) result[8] : true;
        String imageUrl = (String) result[9];
        Double distance = result[10] != null ? ((Number) result[10]).doubleValue() : null;
