...
public interface PlaceRepository extends JpaRepository<Place, Long> {
        ...
        // Public-facing verified queries
        Page<Place> findByVerifiedTrueAndDeletedFalse(Pageable pageable);

        Page<Place> findByCategoryAndVerifiedTrueAndDeletedFalse(PlaceCategory category, Pageable pageable);

        List<Place> findByCategoryAndVerifiedTrueAndDeletedFalse(PlaceCategory category);
        ...
        List<Place> findByCategoryAndVerifiedAndDeletedFalse(PlaceCategory category, Boolean verified);
